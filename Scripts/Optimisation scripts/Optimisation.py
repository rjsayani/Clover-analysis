...
import sys
sys.path.insert(0, '*YOUR FILE PATH*/CLOVER/Scripts/Impact scripts/')
from Finance import Finance
from GHGs import GHGs
sys.path.insert(0, '*YOUR FILE PATH*/CLOVER/Scripts/Conversion scripts')
from Conversion import Conversion
sys.path.insert(0, '*YOUR FILE PATH*/CLOVER/Scripts/Simulation scripts')
from Energy_System import Energy_System
#%%
class Optimisation():
    def __init__(self):
        self.location = 'BS_SA'
        self.CLOVER_filepath = '*YOUR FILE PATH*/CLOVER'
